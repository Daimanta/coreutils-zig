...
pub fn main() !void {
    const params = comptime file_ownership.getParams(file_ownership.Program.CHGRP);
    const ownership_options = file_ownership.getOwnershipOptions(params, application_name, help_message, file_ownership.Program.CHGRP);
